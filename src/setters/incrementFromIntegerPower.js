...
var incrementFromIntegerPower = function incrementFromIntegerPower(peo, integer, powerInput) {
  ...
  for (var i = 0; i < keys.length; i++) {
    ...
    var prime = Number.parseInt(key, 10);     // both prime and exponent are numeric
